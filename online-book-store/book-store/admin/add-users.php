            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-4 text-gray-800">Add users</h1>
                            ...
                            <!-- Circle Buttons -->
                            <div style="height: 1000px" class="card shadow mb-4">
          ...
          <div class="card" style="border-radius: 15px;">
            <div class="card-body p-5">
             ...
             <form method="post" action="add-users.php">
                ...
                <div class="form-outline mb-4">
                <select name="user_type" required id="user-select">
                ...
                <div class="form-outline mb-4">
                  ...
                  <input type="text" id="form3Example3cg" required name="address" class="form-control form-control-lg" />
                </div>
                ...
                <div class="d-flex justify-content-center">
                  <div class="input-group">
                    <input type="submit" name="register_btn" value="Add User">
                  </div>
                </div>
