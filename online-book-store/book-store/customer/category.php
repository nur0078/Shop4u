...
<div class="title_box">Categories</div>
      <ul class="left_menu"> 
        ...
        ?>
                ...
                <?php
                            $id = $_GET['id'];
                            $result = mysql_query("SELECT* from books inner JOIN categories on books.category=categories.categoryId where categoryId='$id'") or die(mysql_error());
                            ...
                            echo'<p><button><a href="#"><font color="white" name="btn">View Description</font></button></p>';
                            echo'</div>';
                            }else {             
