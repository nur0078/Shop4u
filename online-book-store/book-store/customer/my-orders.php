...
<?php
                            ...
                            echo'<h3><font color="darkorange">Ksh '.$row['price'].'</h3></font>';
                            echo'<h2> <font color="black" size="3px">Category: '.$row['name'].'</h2></font>';
                            echo'<p><font color="orange">Description:</font>'.$row['description'].'</p>';
                            echo'<p><button><a href="add-to-cart.php?id='. $row['bookId'] . '"><font color="white" name="btn">Add to Cart</font></button></p>';
                            echo'</div>';
